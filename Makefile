#############################################################################
# Makefile for building: build/ros_qt_controller.app/Contents/MacOS/ros_qt_controller
# Generated by qmake (3.1) (Qt 6.8.2)
# Project:  ros_qt_controller.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile ros_qt_controller.pro
#############################################################################
...
INCPATH       = -I. -Iinclude -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtSvg.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -Ibuild/moc -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/System/Library/Frameworks/AGL.framework/Headers -Ibuild/ui -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/System/Library/Frameworks/AGL.framework/Headers -I/opt/homebrew/share/qt/mkspecs/macx-clang -F/opt/homebrew/lib
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = ros_qt_controller1.0.0
DISTDIR = /Users/xuhengrui/Documents/qt/ros-qt/build/obj/ros_qt_controller1.0.0
...
LIBS          = $(SUBLIBS) -F/opt/homebrew/lib -framework QtWidgets -framework QtSvg -framework QtGui -framework AppKit -framework ImageIO -framework Metal -framework QtCore -framework IOKit -framework DiskArbitration -framework UniformTypeIdentifiers -framework AGL -framework OpenGL   
...
SOURCES       = src/main.cpp \
		src/mainwindow.cpp build/rcc/qrc_resources.cpp \
...
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		ros_qt_controller.pro include/mainwindow.h src/main.cpp \
		src/mainwindow.cpp
QMAKE_TARGET  = ros_qt_controller
DESTDIR       = build/
TARGET        = build/ros_qt_controller.app/Contents/MacOS/ros_qt_controller

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 15.2
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Library/Developer/CommandLineTools
EXPORT__QMAKE_STASH_ = /Users/xuhengrui/Documents/qt/ros-qt/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/xuhengrui/Documents/qt/ros-qt/ros_qt_controller.pro
...
build/ros_qt_controller.app/Contents/MacOS/ros_qt_controller: build/ui/ui_mainwindow.h $(OBJECTS)  
	@test -d build/ros_qt_controller.app/Contents/MacOS/ || mkdir -p build/ros_qt_controller.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: ros_qt_controller.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.8.2/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.8.2/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.8.2/share/qt/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile ros_qt_controller.pro
...
build/ros_qt_controller.app/Contents/PkgInfo: 
	@test -d build/ros_qt_controller.app/Contents || mkdir -p build/ros_qt_controller.app/Contents
	@$(DEL_FILE) build/ros_qt_controller.app/Contents/PkgInfo
	@echo "APPL????" > build/ros_qt_controller.app/Contents/PkgInfo
build/ros_qt_controller.app/Contents/Info.plist: 
	@test -d build/ros_qt_controller.app/Contents || mkdir -p build/ros_qt_controller.app/Contents
	@$(DEL_FILE) build/ros_qt_controller.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.ros-qt-controller,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.ros-qt-controller,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,ros_qt_controller,g" -e "s,@LIBRARY@,ros_qt_controller,g" -e "s,\$${EXECUTABLE_NAME},ros_qt_controller,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >build/ros_qt_controller.app/Contents/Info.plist

all: Makefile \
		build/ros_qt_controller.app/Contents/PkgInfo \
		build/ros_qt_controller.app/Contents/Info.plist build/ros_qt_controller.app/Contents/MacOS/ros_qt_controller
...
distclean: clean 
	-$(DEL_FILE) -r build/ros_qt_controller.app
...
build/rcc/qrc_resources.cpp: resources/resources.qrc \
		...
		resources/icons/direction-indicator.svg \
		resources/icons/connection.svg \
		resources/icons/battery.svg \
		resources/icons/flight-mode.svg
	/opt/homebrew/share/qt/libexec/rcc -name resources resources/resources.qrc -o build/rcc/qrc_resources.cpp
...
build/moc/moc_mainwindow.cpp: include/mainwindow.h \
	...
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/xuhengrui/Documents/qt/ros-qt/build/moc/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/xuhengrui/Documents/qt/ros-qt -I/Users/xuhengrui/Documents/qt/ros-qt/include -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtSvg.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/16/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/opt/homebrew/lib include/mainwindow.h -o build/moc/moc_mainwindow.cpp
...
build/ui/ui_mainwindow.h: ui/mainwindow.ui \
	...
	/opt/homebrew/share/qt/libexec/uic ui/mainwindow.ui -o build/ui/ui_mainwindow.h
